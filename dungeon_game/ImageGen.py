...
#Prompt for testing code, can be replaced with a .get() of the generated text from the actual UI
...
device = "cuda"
pipe = StableDiffusionPipeline.from_pretrained(modelid, revision="fp16", torch_dtype=torch.float16, use_auth_token="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")
pipe.to(device)
